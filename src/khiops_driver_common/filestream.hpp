...
struct FileReader {
    struct Fragment {
        ...
        // This function below must be implemented by the driver to free the memory allocated to the member above.
        inline ~Fragment() { FreeFileReaderFragmentVersion(this); }
    };
...
struct FileWriter {
    ...
    inline ~FileWriter() { FreeFileWriterUserData(this); }
};
