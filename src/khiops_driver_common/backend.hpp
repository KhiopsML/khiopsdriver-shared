...
int ReadFragment(std::string *result, bool *stopped_on_termchar, const FileReader::Fragment &fragment, size_t offset, size_t maxlength);
int ReadFragment(std::string *result, bool *stopped_on_termchar, const FileReader::Fragment &fragment, size_t offset, size_t maxlength, char termchar);
